<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="resourcesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="状态: 0表示正常，1表示禁用" align="center" prop="status" />
...
<script>
import { listResources, getResources, delResources, addResources, updateResources } from "@/api/pubservice/resources";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除公共资源编号为"' + resourceIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('pubservice/resources/export', {
        ...this.queryParams

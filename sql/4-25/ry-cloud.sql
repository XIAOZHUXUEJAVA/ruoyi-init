...
-- ----------------------------
INSERT INTO `city_resources` VALUES (8, '济南', '测试资源', 8, '历城区凤鸣路', 131313, '1');
...
CREATE TABLE `service_category`  (
  ...
  `description` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '描述',
  PRIMARY KEY (`category_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '城市服务类别表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '服务质量表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of service_quality
-- ----------------------------
INSERT INTO `service_quality` VALUES (8, '济南', '在校大学生免费公交', 8, '济南在校大学生一个月免费公交地铁', '不错', '0');
INSERT INTO `service_quality` VALUES (9, '青岛', '大学生免费看海', 9, '看海', '不错', '1');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2085 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '系统管理', 0, 1, 'system', NULL, '', 1, 0, 'M', '0', '0', '', 'system', 'admin', '2024-04-11 14:55:17', 'admin', '2024-04-24 20:18:14', '系统管理目录');
...
INSERT INTO `sys_menu` VALUES (2067, '资源类别', 2066, 1, 'category', 'pubservice/category/index', NULL, 1, 0, 'C', '0', '0', 'pubservice:category:list', '#', 'admin', '2024-04-24 20:57:00', '', NULL, '资源类别菜单');
...
INSERT INTO `sys_menu` VALUES (2073, '公共资源', 2066, 1, 'resources', 'pubservice/resources/index', NULL, 1, 0, 'C', '0', '0', 'pubservice:resources:list', '#', 'admin', '2024-04-24 21:52:08', '', NULL, '公共资源菜单');
...
INSERT INTO `sys_menu` VALUES (2079, '服务类别', 2066, 1, 'servicecategory', 'pubservice/servicecategory/index', NULL, 1, 0, 'C', '0', '0', 'pubservice:servicecategory:list', '#', 'admin', '2024-04-25 16:17:55', '', NULL, '服务类别菜单');
...
INSERT INTO `sys_menu` VALUES (2085, '服务质量', 2066, 1, 'quality', 'pubservice/quality/index', NULL, 1, 0, 'C', '0', '0', 'pubservice:quality:list', '#', 'admin', '2024-04-25 21:37:54', '', NULL, '服务质量菜单');
...
) ENGINE = InnoDB AUTO_INCREMENT = 355 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;

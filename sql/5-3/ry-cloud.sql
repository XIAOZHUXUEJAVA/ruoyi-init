...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '交通事件表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of city_emergency
-- ----------------------------
INSERT INTO `city_emergency` VALUES (8, '济南', 9, '测试', '山东省济南市历城区凤鸣路1000号', '0', '2024-04-28');
INSERT INTO `city_emergency` VALUES (9, '济南', 9, '搜索一下', '山东省济南市历城区凤鸣路1000号', '1', '2024-04-28');
...
-- ----------------------------
INSERT INTO `city_weather` VALUES (8, '青岛', '星期四', '18:00', '16.1', '24', '12', '南风', '3级', '15km/h', '1009', '67%', '2024-05-02');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '事故类别表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 129 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2114 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (2113, '骑行规划', 2049, 1, 'ride', 'traffic/route/ride/index', NULL, 1, 0, 'C', '0', '0', 'traffic:route:ride:list', 'phone', 'admin', '2024-05-02 23:25:25', 'admin', '2024-05-02 23:27:02', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 417 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;

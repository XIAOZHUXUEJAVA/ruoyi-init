...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '交通事件表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of city_emergency
-- ----------------------------
INSERT INTO `city_emergency` VALUES (8, '济南', 9, '测试', '山东省济南市历城区凤鸣路1000号', '0', '2024-04-28');
INSERT INTO `city_emergency` VALUES (9, '济南', 9, '测试电力', '山东省济南市历城区凤鸣路1000号', '1', '2024-04-28');
INSERT INTO `city_emergency` VALUES (10, '济南', 11, '测试公共卫生', '山东省济南市历城区凤鸣路1000号', '0', '2024-05-05');
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '城市设施管理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of city_facilities
-- ----------------------------
INSERT INTO `city_facilities` VALUES (1, '上海', '迪士尼游乐园', '1', '川沙镇申迪西路753号上海迪士尼度假区', '0', 1000);
INSERT INTO `city_facilities` VALUES (8, '济南', '融创茂', '1', '山东省济南市历城区经十路与凤鸣路交叉口', '0', 10000);
...
-- ----------------------------
INSERT INTO `city_resources` VALUES (8, '济南', '测试资源1', 8, '山东省济南市历城区凤鸣路1000号', 131313, '0');
INSERT INTO `city_resources` VALUES (9, '青岛', '测试资源2', 9, ' 山东省青岛市市南区澳门路', 12321, '1');
INSERT INTO `city_resources` VALUES (10, '泰安', '测试资源3', 9, '山东省泰安市岱岳区红门路', 23131, '0');
INSERT INTO `city_resources` VALUES (11, '北京', '测试资源4', 8, '北京市东城区天坛东里甲1号', 31233131, '0');
...
CREATE TABLE `city_traffic`  (
  ...
  PRIMARY KEY (`city_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '城市交通信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `city_traffic` VALUES (10, '青岛', '香港路：畅通。');
...
-- ----------------------------
INSERT INTO `city_weather` VALUES (8, '青岛', '星期二', '15:27', '21.3', '24', '12', '西北风', '3级', '25km/h', '1006', '48%', '2024-05-07');
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '事故类别表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of emergency_category
-- ----------------------------
INSERT INTO `emergency_category` VALUES (8, '火灾', '由于各种原因引发的火灾，可能造成人员伤亡、财产损失和环境污染。');
INSERT INTO `emergency_category` VALUES (9, '电力', '与电力系统相关的各种意外事件或事故，可能导致电力供应中断、电气设备损坏、人员伤亡或财产损失等问题');
INSERT INTO `emergency_category` VALUES (10, '自然', '如地震、洪水、风暴、台风、龙卷风、山火、暴雨等自然灾害，其发生通常由自然力量引起');
INSERT INTO `emergency_category` VALUES (11, '公共卫生', '如传染病爆发、食品安全事件、化学物质泄漏、放射性泄漏等，可能对公共健康造成威胁');
...
-- ----------------------------
INSERT INTO `environment_quality` VALUES (1, '济南', 12, 11, '工业北路有严重的污染物排放', '2024-04-17');
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资源调度表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `resources_category`  (
  ...
  `description` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '描述',
  PRIMARY KEY (`category_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '城市公共资源表' ROW_FORMAT = Dynamic;
...
INSERT INTO `resources_category` VALUES (10, '交通', '包括道路、桥梁、隧道、公共交通系统（公交车、地铁、有轨电车等）、自行车道、停车设施等');
INSERT INTO `resources_category` VALUES (11, '教育', '学校、图书馆、学术机构、培训中心等，提供教育和知识传播服务');
INSERT INTO `resources_category` VALUES (12, '医疗', '医院、诊所、急救中心、药房等，提供医疗保健服务');
INSERT INTO `resources_category` VALUES (13, '文化', '博物馆、美术馆、剧院、音乐厅、文化中心等，提供文化艺术体验和活动');
INSERT INTO `resources_category` VALUES (14, '社会服务', '社区中心、老年活动中心、青少年俱乐部、托儿所等，提供社会服务和支持');
INSERT INTO `resources_category` VALUES (15, '商业', '商业街区、购物中心、市场、餐饮场所等，提供商品和服务交易');
INSERT INTO `resources_category` VALUES (16, '安全', '警察局、消防局、急救中心、警报系统等，确保城市居民的安全');
INSERT INTO `resources_category` VALUES (17, '通讯', '邮局、电话亭、网络覆盖、公共无线网络等，提供通讯服务');
INSERT INTO `resources_category` VALUES (18, '政府机构', '市政府、区政府、市民服务中心等，提供政府服务和治理');
...
CREATE TABLE `service_category`  (
  ...
  `description` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '描述',
  PRIMARY KEY (`category_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '城市服务类别表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of service_category
-- ----------------------------
INSERT INTO `service_category` VALUES (8, '旅游', '旅游景点、旅行社、导游服务等旅游服务');
INSERT INTO `service_category` VALUES (9, '社会保障', '社会保险、社会救助、养老服务等社会保障服务。');
INSERT INTO `service_category` VALUES (10, '社区', '社区卫生服务、社区文化活动、社区安全服务等服务');
INSERT INTO `service_category` VALUES (11, '医疗卫生', '包括医院、诊所、药店等医疗机构的医疗服务，以及健康咨询、预防保健等相关服务');
INSERT INTO `service_category` VALUES (12, '文化体育', '包括图书馆、博物馆、体育场馆、文化活动中心等提供的文化体育服务');
INSERT INTO `service_category` VALUES (13, '工商', '工商注册、税务服务、商标注册等工商服务');
INSERT INTO `service_category` VALUES (14, '商业', '商场、超市、餐饮店、酒店等商业服务');
INSERT INTO `service_category` VALUES (15, '教育', '包括学前教育、小学、初中、高中、大学等各级教育机构的教育服务，以及各类培训机构的培训服务');
...
INSERT INTO `sys_logininfor` VALUES (145, 'admin', '127.0.0.1', '0', '登录成功', '2024-04-29 17:04:43');
INSERT INTO `sys_logininfor` VALUES (146, 'admin', '127.0.0.1', '0', '登录成功', '2024-04-30 17:28:48');
INSERT INTO `sys_logininfor` VALUES (147, 'admin', '127.0.0.1', '0', '登录成功', '2024-05-02 14:54:52');
INSERT INTO `sys_logininfor` VALUES (148, 'admin', '127.0.0.1', '0', '登录成功', '2024-05-02 21:59:19');
INSERT INTO `sys_logininfor` VALUES (149, 'admin', '127.0.0.1', '0', '登录成功', '2024-05-03 11:27:28');
INSERT INTO `sys_logininfor` VALUES (150, 'admin', '127.0.0.1', '0', '登录成功', '2024-05-04 21:21:46');
INSERT INTO `sys_logininfor` VALUES (151, 'admin', '127.0.0.1', '0', '登录成功', '2024-05-05 10:41:44');
INSERT INTO `sys_logininfor` VALUES (152, 'admin', '127.0.0.1', '0', '登录成功', '2024-05-06 10:29:44');
INSERT INTO `sys_logininfor` VALUES (153, 'admin', '127.0.0.1', '0', '登录成功', '2024-05-07 11:19:25');
INSERT INTO `sys_logininfor` VALUES (154, 'admin', '127.0.0.1', '0', '登录成功', '2024-05-08 10:41:23');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2119 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_menu` VALUES (2093, '事故类别', 2092, 1, 'category', 'emergency/category/index', NULL, 1, 0, 'C', '0', '0', 'emergency:category:list', 'table', 'admin', '2024-04-26 21:19:32', 'admin', '2024-05-05 10:51:30', '事故类别菜单');
...
INSERT INTO `sys_menu` VALUES (2099, '应急事件', 2092, 1, 'emergency', 'emergency/emergency/index', NULL, 1, 0, 'C', '0', '0', 'emergency:emergency:list', 'drag', 'admin', '2024-04-28 13:20:24', 'admin', '2024-05-05 10:52:00', '交通事件菜单');
...
INSERT INTO `sys_menu` VALUES (2105, '资源调度', 2092, 1, 'dispatch', 'emergency/dispatch/index', NULL, 1, 0, 'C', '0', '0', 'emergency:dispatch:list', 'link', 'admin', '2024-04-28 18:53:11', 'admin', '2024-05-05 10:51:43', '资源调度菜单');
...
INSERT INTO `sys_menu` VALUES (2112, '地址检索', 0, 0, 'search', 'search/index', NULL, 1, 0, 'C', '0', '0', '', 'build', 'admin', '2024-05-02 18:12:47', 'admin', '2024-05-02 19:20:55', '');
INSERT INTO `sys_menu` VALUES (2113, '骑行规划', 2049, 1, 'ride', 'traffic/route/ride/index', NULL, 1, 0, 'C', '0', '0', 'traffic:route:ride:list', 'ride', 'admin', '2024-05-02 23:25:25', 'admin', '2024-05-03 11:35:24', '');
INSERT INTO `sys_menu` VALUES (2114, '智能车位', 2039, 4, 'stop', 'traffic/stop/index', NULL, 1, 0, 'C', '0', '0', 'traffic:stop:list', 'build', 'admin', '2024-05-03 11:59:16', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2115, '城市内景', 0, 0, 'inner', 'inner/index', NULL, 1, 0, 'C', '0', '0', NULL, 'build', 'admin', '2024-05-05 16:20:43', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2118, '城市经济实况', 2014, 4, 'http://10.217.95.119:8081', NULL, NULL, 0, 0, 'M', '0', '0', NULL, 'chart', 'admin', '2024-05-07 11:26:48', '', NULL, '');
...
INSERT INTO `sys_oper_log` VALUES (403, '资源调度', 2, 'com.ruoyi.emergency.controller.ResourceDispatchController.edit()', 'PUT', 1, 'admin', NULL, '/dispatch', '127.0.0.1', '', '{\"content\":\"测试\",\"dispatchDate\":\"2024-04-28\",\"dispatchId\":10,\"emergencyId\":8,\"params\":{},\"resourceId\":9,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-04-29 17:11:25', 36);
INSERT INTO `sys_oper_log` VALUES (404, '资源调度', 2, 'com.ruoyi.emergency.controller.ResourceDispatchController.edit()', 'PUT', 1, 'admin', NULL, '/dispatch', '127.0.0.1', '', '{\"content\":\"测试\",\"dispatchDate\":\"2024-04-28\",\"dispatchId\":10,\"emergencyId\":8,\"params\":{},\"resourceId\":9,\"status\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-04-29 17:11:29', 4);
INSERT INTO `sys_oper_log` VALUES (405, '交通事件', 2, 'com.ruoyi.emergency.controller.CityEmergencyController.edit()', 'PUT', 1, 'admin', NULL, '/emergency', '127.0.0.1', '', '{\"categoryId\":9,\"cityName\":\"济南\",\"description\":\"搜索一下\",\"emergencyAddress\":\"山东省济南市历城区凤鸣路1000号\",\"emergencyDate\":\"2024-04-28\",\"emergencyId\":9,\"params\":{},\"status\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-04-30 17:29:35', 30);
INSERT INTO `sys_oper_log` VALUES (406, '城市设施管理', 1, 'com.ruoyi.city.controller.CityFacilitiesController.add()', 'POST', 1, 'admin', NULL, '/facilities', '127.0.0.1', '', '{\"address\":\"测试\",\"capacity\":10000,\"cityName\":\"济南\",\"facilityId\":8,\"facilityName\":\"融创茂\",\"isPublic\":\"1\",\"params\":{},\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 15:09:40', 35);
INSERT INTO `sys_oper_log` VALUES (407, '城市设施管理', 2, 'com.ruoyi.city.controller.CityFacilitiesController.edit()', 'PUT', 1, 'admin', NULL, '/facilities', '127.0.0.1', '', '{\"address\":\"山东省济南市历城区经十路与凤鸣路交叉口\",\"capacity\":10000,\"cityName\":\"济南\",\"facilityId\":8,\"facilityName\":\"融创茂\",\"isPublic\":\"1\",\"params\":{},\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 15:10:55', 6);
INSERT INTO `sys_oper_log` VALUES (408, '城市设施管理', 2, 'com.ruoyi.city.controller.CityFacilitiesController.edit()', 'PUT', 1, 'admin', NULL, '/facilities', '127.0.0.1', '', '{\"address\":\"川沙镇申迪西路753号上海迪士尼度假区\",\"capacity\":1000,\"cityName\":\"上海\",\"facilityId\":1,\"facilityName\":\"迪士尼游乐园\",\"isPublic\":\"1\",\"params\":{},\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 15:11:20', 4);
INSERT INTO `sys_oper_log` VALUES (409, '城市天气', 2, 'com.ruoyi.citydata.controller.CityWeatherController.edit()', 'PUT', 1, 'admin', NULL, '/weather', '127.0.0.1', '', '{\"city\":\"青岛\",\"date\":\"2024-05-02\",\"humidity\":\"67%\",\"params\":{},\"pressrue\":\"1009\",\"recordId\":8,\"tem\":\"16.1\",\"temDay\":\"24\",\"temNight\":\"12\",\"updateDate\":\"18:00\",\"week\":\"星期四\",\"win\":\"南风\",\"winMeter\":\"15km/h\",\"winSpeed\":\"3级\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 18:01:06', 42);
INSERT INTO `sys_oper_log` VALUES (410, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"build\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"地址检索\",\"menuType\":\"M\",\"orderNum\":2,\"params\":{},\"parentId\":0,\"path\":\"search\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 18:09:06', 27);
INSERT INTO `sys_oper_log` VALUES (411, '菜单管理', 3, 'com.ruoyi.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/menu/2111', '127.0.0.1', '', '{}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 18:10:54', 13);
INSERT INTO `sys_oper_log` VALUES (412, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"search/index\",\"createBy\":\"admin\",\"icon\":\"build\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"地址检索\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":0,\"path\":\"search\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 18:12:47', 7);
INSERT INTO `sys_oper_log` VALUES (413, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"search/index\",\"createTime\":\"2024-05-02 18:12:47\",\"icon\":\"build\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2112,\"menuName\":\"地址检索\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":0,\"path\":\"search\",\"perms\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 19:20:55', 12);
INSERT INTO `sys_oper_log` VALUES (414, '资源调度', 2, 'com.ruoyi.emergency.controller.ResourceDispatchController.edit()', 'PUT', 1, 'admin', NULL, '/dispatch', '127.0.0.1', '', '{\"content\":\"测试\",\"dispatchDate\":\"2024-04-28\",\"dispatchId\":9,\"emergencyId\":8,\"params\":{},\"resourceId\":8,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 22:16:01', 38);
INSERT INTO `sys_oper_log` VALUES (415, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"taffic/route/ride/index\",\"createBy\":\"admin\",\"icon\":\"phone\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"骑行规划\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2049,\"path\":\"ride\",\"perms\":\"traffic:route:ride:list\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 23:25:26', 25);
INSERT INTO `sys_oper_log` VALUES (416, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"traffic/route/ride/index\",\"createTime\":\"2024-05-02 23:25:25\",\"icon\":\"phone\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2113,\"menuName\":\"骑行规划\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2049,\"path\":\"ride\",\"perms\":\"traffic:route:ride:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-02 23:27:02', 7);
INSERT INTO `sys_oper_log` VALUES (417, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"traffic/route/ride/index\",\"createTime\":\"2024-05-02 23:25:25\",\"icon\":\"ride\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2113,\"menuName\":\"骑行规划\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2049,\"path\":\"ride\",\"perms\":\"traffic:route:ride:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-03 11:35:24', 19);
INSERT INTO `sys_oper_log` VALUES (418, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"traffic/stop/index\",\"createBy\":\"admin\",\"icon\":\"build\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"智能车位\",\"menuType\":\"C\",\"orderNum\":4,\"params\":{},\"parentId\":2039,\"path\":\"stop\",\"perms\":\"traffic:stop:list\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-03 11:59:16', 7);
INSERT INTO `sys_oper_log` VALUES (419, '资源类别', 1, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":10,\"categoryName\":\"交通\",\"description\":\"包括道路、桥梁、隧道、公共交通系统（公交车、地铁、有轨电车等）、自行车道、停车设施等。\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:43:09', 37);
INSERT INTO `sys_oper_log` VALUES (420, '资源类别', 1, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":11,\"categoryName\":\"教育\",\"description\":\"学校、图书馆、学术机构、培训中心等，提供教育和知识传播服务。\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:43:45', 4);
INSERT INTO `sys_oper_log` VALUES (421, '资源类别', 1, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":12,\"categoryName\":\"医疗\",\"description\":\"医院、诊所、急救中心、药房等，提供医疗保健服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:44:01', 2);
INSERT INTO `sys_oper_log` VALUES (422, '资源类别', 2, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.edit()', 'PUT', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":11,\"categoryName\":\"教育\",\"description\":\"学校、图书馆、学术机构、培训中心等，提供教育和知识传播服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:44:05', 6);
INSERT INTO `sys_oper_log` VALUES (423, '资源类别', 2, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.edit()', 'PUT', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":10,\"categoryName\":\"交通\",\"description\":\"包括道路、桥梁、隧道、公共交通系统（公交车、地铁、有轨电车等）、自行车道、停车设施等\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:44:08', 3);
INSERT INTO `sys_oper_log` VALUES (424, '资源类别', 1, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":13,\"categoryName\":\"文化\",\"description\":\"博物馆、美术馆、剧院、音乐厅、文化中心等，提供文化艺术体验和活动\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:44:20', 4);
INSERT INTO `sys_oper_log` VALUES (425, '资源类别', 1, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":14,\"categoryName\":\"社会服务\",\"description\":\"社区中心、老年活动中心、青少年俱乐部、托儿所等，提供社会服务和支持\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:44:42', 6);
INSERT INTO `sys_oper_log` VALUES (426, '资源类别', 1, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":15,\"categoryName\":\"商业\",\"description\":\"商业街区、购物中心、市场、餐饮场所等，提供商品和服务交易\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:44:55', 1);
INSERT INTO `sys_oper_log` VALUES (427, '资源类别', 1, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":16,\"categoryName\":\"安全\",\"description\":\"警察局、消防局、急救中心、警报系统等，确保城市居民的安全\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:45:12', 4);
INSERT INTO `sys_oper_log` VALUES (428, '资源类别', 1, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":17,\"categoryName\":\"通讯\",\"description\":\"邮局、电话亭、网络覆盖、公共无线网络等，提供通讯服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:45:30', 3);
INSERT INTO `sys_oper_log` VALUES (429, '资源类别', 1, 'com.ruoyi.pubservice.controller.ResourcesCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":18,\"categoryName\":\"政府机构\",\"description\":\"市政府、区政府、市民服务中心等，提供政府服务和治理\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:45:44', 4);
INSERT INTO `sys_oper_log` VALUES (430, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"emergency/category/index\",\"createTime\":\"2024-04-26 21:19:32\",\"icon\":\"table\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2093,\"menuName\":\"事故类别\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2092,\"path\":\"category\",\"perms\":\"emergency:category:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:51:30', 18);
INSERT INTO `sys_oper_log` VALUES (431, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"emergency/dispatch/index\",\"createTime\":\"2024-04-28 18:53:11\",\"icon\":\"link\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2105,\"menuName\":\"资源调度\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2092,\"path\":\"dispatch\",\"perms\":\"emergency:dispatch:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:51:43', 6);
INSERT INTO `sys_oper_log` VALUES (432, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"emergency/emergency/index\",\"createTime\":\"2024-04-28 13:20:24\",\"icon\":\"drag\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2099,\"menuName\":\"应急事件\",\"menuType\":\"C\",\"orderNum\":1,\"params\":{},\"parentId\":2092,\"path\":\"emergency\",\"perms\":\"emergency:emergency:list\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:52:00', 5);
INSERT INTO `sys_oper_log` VALUES (433, '事故类别', 1, 'com.ruoyi.emergency.controller.EmergencyCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":10,\"categoryName\":\"自然\",\"description\":\"如地震、洪水、风暴、台风、龙卷风、山火、暴雨等自然灾害，其发生通常由自然力量引起\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:53:34', 43);
INSERT INTO `sys_oper_log` VALUES (434, '事故类别', 1, 'com.ruoyi.emergency.controller.EmergencyCategoryController.add()', 'POST', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":11,\"categoryName\":\"公共卫生\",\"description\":\"如传染病爆发、食品安全事件、化学物质泄漏、放射性泄漏等，可能对公共健康造成威胁\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:54:23', 5);
INSERT INTO `sys_oper_log` VALUES (435, '事故类别', 2, 'com.ruoyi.emergency.controller.EmergencyCategoryController.edit()', 'PUT', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":8,\"categoryName\":\"火灾\",\"description\":\"由于各种原因引发的火灾，可能造成人员伤亡、财产损失和环境污染。\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:54:47', 5);
INSERT INTO `sys_oper_log` VALUES (436, '事故类别', 2, 'com.ruoyi.emergency.controller.EmergencyCategoryController.edit()', 'PUT', 1, 'admin', NULL, '/category', '127.0.0.1', '', '{\"categoryId\":9,\"categoryName\":\"电力\",\"description\":\"与电力系统相关的各种意外事件或事故，可能导致电力供应中断、电气设备损坏、人员伤亡或财产损失等问题\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 10:55:11', 4);
INSERT INTO `sys_oper_log` VALUES (437, '城市环境质量', 2, 'com.ruoyi.citydata.controller.EnvironmentQualityController.edit()', 'PUT', 1, 'admin', NULL, '/quality', '127.0.0.1', '', '{\"airQuality\":12,\"cityName\":\"济南\",\"envId\":1,\"noiseLevel\":11,\"params\":{},\"pollutantEmission\":\"工业北路有严重的污染物排放\",\"recordDate\":\"2024-04-17\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 11:01:40', 34);
INSERT INTO `sys_oper_log` VALUES (438, '城市天气', 2, 'com.ruoyi.citydata.controller.CityWeatherController.edit()', 'PUT', 1, 'admin', NULL, '/weather', '127.0.0.1', '', '{\"city\":\"青岛\",\"date\":\"2024-05-05\",\"humidity\":\"85%\",\"params\":{},\"pressrue\":\"997\",\"recordId\":8,\"tem\":\"13.8\",\"temDay\":\"18\",\"temNight\":\"12\",\"updateDate\":\"15:14\",\"week\":\"星期日\",\"win\":\"西北风\",\"winMeter\":\"18km/h\",\"winSpeed\":\"3级\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:19:50', 13);
INSERT INTO `sys_oper_log` VALUES (439, '公共资源', 2, 'com.ruoyi.pubservice.controller.CityResourcesController.edit()', 'PUT', 1, 'admin', NULL, '/resources', '127.0.0.1', '', '{\"address\":\"泰山\",\"capacity\":23131,\"categoryId\":9,\"cityName\":\"泰安\",\"params\":{},\"resourceId\":10,\"resourceName\":\"测试3\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:22:16', 11);
INSERT INTO `sys_oper_log` VALUES (440, '公共资源', 2, 'com.ruoyi.pubservice.controller.CityResourcesController.edit()', 'PUT', 1, 'admin', NULL, '/resources', '127.0.0.1', '', '{\"address\":\"天坛\",\"capacity\":31233131,\"categoryId\":8,\"cityName\":\"北京\",\"params\":{},\"resourceId\":11,\"resourceName\":\"测试资源4\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:22:27', 4);
INSERT INTO `sys_oper_log` VALUES (441, '公共资源', 2, 'com.ruoyi.pubservice.controller.CityResourcesController.edit()', 'PUT', 1, 'admin', NULL, '/resources', '127.0.0.1', '', '{\"address\":\"泰山\",\"capacity\":23131,\"categoryId\":9,\"cityName\":\"泰安\",\"params\":{},\"resourceId\":10,\"resourceName\":\"测试资源3\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:22:33', 4);
INSERT INTO `sys_oper_log` VALUES (442, '公共资源', 2, 'com.ruoyi.pubservice.controller.CityResourcesController.edit()', 'PUT', 1, 'admin', NULL, '/resources', '127.0.0.1', '', '{\"address\":\"五四广场\",\"capacity\":12321,\"categoryId\":9,\"cityName\":\"青岛\",\"params\":{},\"resourceId\":9,\"resourceName\":\"测试资源2\",\"status\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:22:45', 5);
INSERT INTO `sys_oper_log` VALUES (443, '公共资源', 2, 'com.ruoyi.pubservice.controller.CityResourcesController.edit()', 'PUT', 1, 'admin', NULL, '/resources', '127.0.0.1', '', '{\"address\":\"历城区凤鸣路\",\"capacity\":131313,\"categoryId\":8,\"cityName\":\"济南\",\"params\":{},\"resourceId\":8,\"resourceName\":\"测试资源1\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:22:52', 6);
INSERT INTO `sys_oper_log` VALUES (444, '公共资源', 2, 'com.ruoyi.pubservice.controller.CityResourcesController.edit()', 'PUT', 1, 'admin', NULL, '/resources', '127.0.0.1', '', '{\"address\":\"山东省济南市历城区凤鸣路1000号\",\"capacity\":131313,\"categoryId\":8,\"cityName\":\"济南\",\"params\":{},\"resourceId\":8,\"resourceName\":\"测试资源1\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:23:12', 4);
INSERT INTO `sys_oper_log` VALUES (445, '公共资源', 2, 'com.ruoyi.pubservice.controller.CityResourcesController.edit()', 'PUT', 1, 'admin', NULL, '/resources', '127.0.0.1', '', '{\"address\":\" 山东省青岛市市南区澳门路\",\"capacity\":12321,\"categoryId\":9,\"cityName\":\"青岛\",\"params\":{},\"resourceId\":9,\"resourceName\":\"测试资源2\",\"status\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:23:41', 3);
INSERT INTO `sys_oper_log` VALUES (446, '公共资源', 2, 'com.ruoyi.pubservice.controller.CityResourcesController.edit()', 'PUT', 1, 'admin', NULL, '/resources', '127.0.0.1', '', '{\"address\":\"山东省泰安市岱岳区红门路\",\"capacity\":23131,\"categoryId\":9,\"cityName\":\"泰安\",\"params\":{},\"resourceId\":10,\"resourceName\":\"测试资源3\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:24:25', 4);
INSERT INTO `sys_oper_log` VALUES (447, '公共资源', 2, 'com.ruoyi.pubservice.controller.CityResourcesController.edit()', 'PUT', 1, 'admin', NULL, '/resources', '127.0.0.1', '', '{\"address\":\"北京市东城区天坛东里甲1号\",\"capacity\":31233131,\"categoryId\":8,\"cityName\":\"北京\",\"params\":{},\"resourceId\":11,\"resourceName\":\"测试资源4\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:24:58', 4);
INSERT INTO `sys_oper_log` VALUES (448, '服务类别', 2, 'com.ruoyi.pubservice.controller.ServiceCategoryController.edit()', 'PUT', 1, 'admin', NULL, '/servicecategory', '127.0.0.1', '', '{\"categoryId\":8,\"categoryName\":\"旅游\",\"description\":\"旅游景点、旅行社、导游服务等旅游服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:30:06', 6);
INSERT INTO `sys_oper_log` VALUES (449, '服务类别', 2, 'com.ruoyi.pubservice.controller.ServiceCategoryController.edit()', 'PUT', 1, 'admin', NULL, '/servicecategory', '127.0.0.1', '', '{\"categoryId\":9,\"categoryName\":\"社会保障\",\"description\":\"社会保险、社会救助、养老服务等社会保障服务。\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:30:33', 4);
INSERT INTO `sys_oper_log` VALUES (450, '服务类别', 1, 'com.ruoyi.pubservice.controller.ServiceCategoryController.add()', 'POST', 1, 'admin', NULL, '/servicecategory', '127.0.0.1', '', '{\"categoryId\":10,\"categoryName\":\"社区\",\"description\":\"社区卫生服务、社区文化活动、社区安全服务等服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:30:57', 5);
INSERT INTO `sys_oper_log` VALUES (451, '服务类别', 1, 'com.ruoyi.pubservice.controller.ServiceCategoryController.add()', 'POST', 1, 'admin', NULL, '/servicecategory', '127.0.0.1', '', '{\"categoryId\":11,\"categoryName\":\"医疗卫生\",\"description\":\"包括医院、诊所、药店等医疗机构的医疗服务，以及健康咨询、预防保健等相关服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:31:13', 4);
INSERT INTO `sys_oper_log` VALUES (452, '服务类别', 1, 'com.ruoyi.pubservice.controller.ServiceCategoryController.add()', 'POST', 1, 'admin', NULL, '/servicecategory', '127.0.0.1', '', '{\"categoryId\":12,\"categoryName\":\"文化体育\",\"description\":\"包括图书馆、博物馆、体育场馆、文化活动中心等提供的文化体育服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:31:41', 4);
INSERT INTO `sys_oper_log` VALUES (453, '服务类别', 1, 'com.ruoyi.pubservice.controller.ServiceCategoryController.add()', 'POST', 1, 'admin', NULL, '/servicecategory', '127.0.0.1', '', '{\"categoryId\":13,\"categoryName\":\"工商\",\"description\":\"工商注册、税务服务、商标注册等工商服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:32:02', 4);
INSERT INTO `sys_oper_log` VALUES (454, '服务类别', 1, 'com.ruoyi.pubservice.controller.ServiceCategoryController.add()', 'POST', 1, 'admin', NULL, '/servicecategory', '127.0.0.1', '', '{\"categoryId\":14,\"categoryName\":\"商业\",\"description\":\"商场、超市、餐饮店、酒店等商业服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:32:17', 5);
INSERT INTO `sys_oper_log` VALUES (455, '服务类别', 1, 'com.ruoyi.pubservice.controller.ServiceCategoryController.add()', 'POST', 1, 'admin', NULL, '/servicecategory', '127.0.0.1', '', '{\"categoryId\":15,\"categoryName\":\"教育\",\"description\":\"包括学前教育、小学、初中、高中、大学等各级教育机构的教育服务，以及各类培训机构的培训服务\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:32:48', 3);
INSERT INTO `sys_oper_log` VALUES (456, '路况检测', 1, 'com.ruoyi.traffic.controller.CityTrafficController.add()', 'POST', 1, 'admin', NULL, '/traffic', '127.0.0.1', '', '{\"cityId\":10,\"cityName\":\"青岛\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:43:15', 37);
INSERT INTO `sys_oper_log` VALUES (457, '路况检测', 2, 'com.ruoyi.traffic.controller.CityTrafficController.edit()', 'PUT', 1, 'admin', NULL, '/traffic', '127.0.0.1', '', '{\"cityId\":10,\"cityName\":\"青岛\",\"description\":\"香港路：畅通。\",\"params\":{}}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:43:56', 5);
INSERT INTO `sys_oper_log` VALUES (458, '交通事件', 2, 'com.ruoyi.traffic.controller.CityAccidentController.edit()', 'PUT', 1, 'admin', NULL, '/accident', '127.0.0.1', '', '{\"accidentAddress\":\"山东省济南市历城区凤鸣路1000号\",\"accidentId\":8,\"cityName\":\"济南\",\"description\":\"发生事故\",\"params\":{},\"recordDate\":\"2024-04-22\",\"status\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:45:30', 14);
INSERT INTO `sys_oper_log` VALUES (459, '交通事件', 2, 'com.ruoyi.traffic.controller.CityAccidentController.edit()', 'PUT', 1, 'admin', NULL, '/accident', '127.0.0.1', '', '{\"accidentAddress\":\"山东省济南市历城区凤鸣路1000号\",\"accidentId\":8,\"cityName\":\"济南\",\"description\":\"发生事故\",\"params\":{},\"recordDate\":\"2024-04-22\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 15:45:37', 5);
INSERT INTO `sys_oper_log` VALUES (460, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"inner/index\",\"createBy\":\"admin\",\"icon\":\"build\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"城市内景\",\"menuType\":\"C\",\"orderNum\":0,\"params\":{},\"parentId\":0,\"path\":\"inner\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 16:20:44', 10);
INSERT INTO `sys_oper_log` VALUES (461, '交通事件', 1, 'com.ruoyi.emergency.controller.CityEmergencyController.add()', 'POST', 1, 'admin', NULL, '/emergency', '127.0.0.1', '', '{\"categoryId\":11,\"cityName\":\"济南\",\"description\":\"发生食物中毒\",\"emergencyAddress\":\"山东省济南市历城区凤鸣路1000号\",\"emergencyDate\":\"2024-05-05\",\"emergencyId\":10,\"params\":{},\"status\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 21:02:12', 43);
INSERT INTO `sys_oper_log` VALUES (462, '交通事件', 2, 'com.ruoyi.emergency.controller.CityEmergencyController.edit()', 'PUT', 1, 'admin', NULL, '/emergency', '127.0.0.1', '', '{\"categoryId\":11,\"cityName\":\"济南\",\"description\":\"发生食物中毒\",\"emergencyAddress\":\"山东省济南市历城区凤鸣路1000号\",\"emergencyDate\":\"2024-05-05\",\"emergencyId\":10,\"params\":{},\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 21:06:31', 10);
INSERT INTO `sys_oper_log` VALUES (463, '交通事件', 2, 'com.ruoyi.emergency.controller.CityEmergencyController.edit()', 'PUT', 1, 'admin', NULL, '/emergency', '127.0.0.1', '', '{\"categoryId\":11,\"cityName\":\"济南\",\"description\":\"测试公共卫生\",\"emergencyAddress\":\"山东省济南市历城区凤鸣路1000号\",\"emergencyDate\":\"2024-05-05\",\"emergencyId\":10,\"params\":{},\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 21:08:12', 4);
INSERT INTO `sys_oper_log` VALUES (464, '交通事件', 2, 'com.ruoyi.emergency.controller.CityEmergencyController.edit()', 'PUT', 1, 'admin', NULL, '/emergency', '127.0.0.1', '', '{\"categoryId\":9,\"cityName\":\"济南\",\"description\":\"测试电力\",\"emergencyAddress\":\"山东省济南市历城区凤鸣路1000号\",\"emergencyDate\":\"2024-04-28\",\"emergencyId\":9,\"params\":{},\"status\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 21:08:22', 5);
INSERT INTO `sys_oper_log` VALUES (465, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"component\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"城市经济数据\",\"menuType\":\"M\",\"orderNum\":4,\"params\":{},\"parentId\":2014,\"path\":\"http://10.217.95.119:8081\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-07 11:21:42', 18);
INSERT INTO `sys_oper_log` VALUES (466, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createTime\":\"2024-05-07 11:21:41\",\"icon\":\"component\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2116,\"menuName\":\"城市经济数据\",\"menuType\":\"C\",\"orderNum\":4,\"params\":{},\"parentId\":2014,\"path\":\"http://10.217.95.119:8081\",\"perms\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-07 11:22:56', 3);
INSERT INTO `sys_oper_log` VALUES (467, '菜单管理', 3, 'com.ruoyi.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/menu/2116', '127.0.0.1', '', '{}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-07 11:23:59', 13);
INSERT INTO `sys_oper_log` VALUES (468, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"23-route\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"GDP\",\"menuType\":\"M\",\"orderNum\":4,\"params\":{},\"parentId\":0,\"path\":\"http://10.217.95.119:8081\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-07 11:24:35', 7);
INSERT INTO `sys_oper_log` VALUES (469, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createTime\":\"2024-05-07 11:24:35\",\"icon\":\"23-route\",\"isCache\":\"0\",\"isFrame\":\"0\",\"menuId\":2117,\"menuName\":\"GDP\",\"menuType\":\"M\",\"orderNum\":4,\"params\":{},\"parentId\":0,\"path\":\"http://10.217.95.119:8081\",\"perms\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-07 11:25:32', 6);
INSERT INTO `sys_oper_log` VALUES (470, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createBy\":\"admin\",\"icon\":\"chart\",\"isCache\":\"0\",\"isFrame\":\"0\",\"menuName\":\"城市经济实况\",\"menuType\":\"M\",\"orderNum\":4,\"params\":{},\"parentId\":2014,\"path\":\"http://10.217.95.119:8081\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-07 11:26:48', 5);
INSERT INTO `sys_oper_log` VALUES (471, '城市天气', 2, 'com.ruoyi.citydata.controller.CityWeatherController.edit()', 'PUT', 1, 'admin', NULL, '/weather', '127.0.0.1', '', '{\"city\":\"青岛\",\"date\":\"2024-05-07\",\"humidity\":\"48%\",\"params\":{},\"pressrue\":\"1006\",\"recordId\":8,\"tem\":\"21.3\",\"temDay\":\"24\",\"temNight\":\"12\",\"updateDate\":\"15:27\",\"week\":\"星期二\",\"win\":\"西北风\",\"winMeter\":\"25km/h\",\"winSpeed\":\"3级\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-07 15:31:53', 48);
INSERT INTO `sys_oper_log` VALUES (472, '菜单管理', 3, 'com.ruoyi.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/menu/2117', '127.0.0.1', '', '{}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-08 10:45:05', 13);
